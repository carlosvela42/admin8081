...
public class UserService implements UserDetailsService {
    ...
    public void sendEmail(String content, String subject,String listRec) {
		...
		commonConfig.setProperty("email.host", "epaymail.megapay.vn");		
		...
		commonConfig.setProperty("email.username", "alert@megapay.vn");
		commonConfig.setProperty("email.password", "F343#$sdf429");
